        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DomainBasTarihi = table.Column<DateTime>(nullable: true),
                    DomainBitisTarihi = table.Column<DateTime>(nullable: true),
                    PanelFtpBilgi = table.Column<string>(nullable: true),
                    HostingBasTarihi = table.Column<DateTime>(nullable: true),
                    HostingBitisTarihi = table.Column<DateTime>(nullable: true),
